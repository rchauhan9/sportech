...
if [[ -z "${GITHUB_TOKEN}" ]] || [[ -z "${GITHUB_ACTOR}" ]]; then
  err "GITHUB_ACTOR/GITHUB_TOKEN environment variables were not found! These are required for docker setup."
  err "Please make sure you've set these up properly - follow the guide at https://github.com/upside-tech/monorepo/blob/main/docs/welcome/README.md"
  exit 1
fi
...
info
info "Please continue the welcome guide as it explains some manual things that require setting up."
